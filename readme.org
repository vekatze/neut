...
define i64 @main() {
  ...
  %_12040 = getelementptr [1 x i8], [1 x i8]* %_12037, i32 0, i64 0
  store i8 %_12039, i8* %_12040
  ;; write the string into stdout for the three times
  %_12041 = inttoptr i64 1 to i8* ;; write to stdout (= 1)
  %_12042 = inttoptr i64 1 to i8* ;; the length of the string
