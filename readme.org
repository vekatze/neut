...
This is made possible by translating every type of the language into a function that can be used to copy/discard the terms of the type. Thereforee, in this language, a type is not erased, but translated into a computationally-meaningful term.
...
- [[#examples][Examples]]
  ...
  - [[#noetic-computation][Noetic Computation]]
