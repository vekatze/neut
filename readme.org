...
- [[#syntax-and-semantics-of-statements][Syntax and Semantics of Statements]]
  - [[#attribute-add-an-attribute-to-a-variable][=attribute=: Add an Attribute to a Variable]]
  - [[#constant-declare-external-constant-eg-syscall][Constant: Declare External Constant (e.g. Syscall)]]
  - [[#definelet-define-a-variable][Define/Let: Define a variable]]
  - [[#ensure-fetch-the-content-of-specified-url-to-be-used-as-library][Ensure: Fetch the Content of Specified URL to be Used as Library]]
  - [[#enum-declare-enum-type][Enum: Declare Enum Type]]
  - [[#include-include-the-content-of-the-file-located-at-the-specified-path][Include: Include the Content of the File located at the Specified Path]]
  - [[#inductivecoinductive-declare-inductivecoinductive-type-and-its-introductionelimination-rules][Inductive/Coinductive: Declare Inductive/Coinductive Type and its Introduction/Elimination Rules]]
  - [[#introspect-for-platform-dependent-code][Introspect: For Platform-Dependent Code]]
  - [[#keywordnotation-define-convenient-notations-macros][Keyword/Notation: Define Convenient Notations (Macros)]]
  - [[#useunusesectionend-namespace-control][Use/Unuse/Section/End: Namespace Control]]
  - [[#verify-for-theorem-proving][Verify: For theorem proving]]
- [[#core-syntax-and-semantics-of-terms][Core Syntax and Semantics of Terms]]
...
- [[#auxiliary-syntax][Auxiliary Syntax]]
  ...
  - [[#with-notation-explicit-do-notation][With Notation: Explicit do-Notation]]
  - [[#record][Record]]
...
** =attribute=: Add an Attribute to a Variable

** Constant: Declare External Constant (e.g. Syscall)

** Define/Let: Define a variable

** Ensure: Fetch the Content of Specified URL to be Used as Library

** Enum: Declare Enum Type

** Include: Include the Content of the File located at the Specified Path

** Inductive/Coinductive: Declare Inductive/Coinductive Type and its Introduction/Elimination Rules

** Introspect: For Platform-Dependent Code

** Keyword/Notation: Define Convenient Notations (Macros)

** Use/Unuse/Section/End: Namespace Control

** Verify: For theorem proving

* Core Syntax and Semantics of Terms
...
** With Notation: Explicit do-Notation
