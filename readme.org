...
#+END_SRC
*** Notes
If a node =(e e1 ... en)= is not parsed into any other terms, the node is parsed as =(pi-elimination e e1 ... en)=.
...
Some additional notations for pi is defined by default:
#+BEGIN_SRC scheme
(keyword forall)
