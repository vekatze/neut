...
Here I will write code in a rather verbose way to make things as explicit as possible to the readers. You don't have to be that verbose in the actual code, of course.
