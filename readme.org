...
#+end_src
**** Semantics
=(if-meta e on-true on-false)= firstly reduces the =e=. If the =e= is reduced into =(node)= (i.e. =`()=, or nil), then this =if-meta= is reduced into =on-false=, and reduction for this term follows. Otherwise, this =if-meta= is reduced into =on-true=, and reduction for this term follows.
