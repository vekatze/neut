...
Practically, this means that you can write your program in ordinary lambda-calculus without any extra restrictions or annotations, and at the same time you are allowed to control how resources are used in the program. If you want a ordinary-lambda-calculus based programming language with a human-predictable semantics (including its memory management), this might be for you.
...
- Memory allocations/deallocations are statically determined at compile time
