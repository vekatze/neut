...
- [[#1-some-hopefully-illuminating-examples][1. Some (Hopefully) Illuminating Examples]]
...
- [[#3-syntax-and-semantics-of-statements][3. Syntax and Semantics of Statements]]
  - [[#attribute][attribute]]
  - [[#constant][constant]]
  ...
  - [[#verify][verify]]
- [[#4-syntax-and-semantics-of-terms][4. Syntax and Semantics of Terms]]
  ...
  - [[#array][Array]]
  - [[#struct][Struct]]
- [[#5-auxiliary-syntax][5. Auxiliary Syntax]]
...
- [[#6-compiler-commands][6. Compiler Commands]]
  - [[#archive][archive]]
  - [[#build][build]]
  - [[#check][check]]
  - [[#complete][complete]]
- [[#7-where-is-][7. Where is ...?]]
  - [[#unsigned-integers][Unsigned Integers?]]
  - [[#typeclass][Typeclass?]]
  - [[#proof-related-stuff][Proof-Related Stuff?]]
  - [[#the-universe-hierarchy][The Universe Hierarchy?]]
- [[#8-theoretical-notes][8. Theoretical Notes]]
...
* 1. Some (Hopefully) Illuminating Examples
...
* 3. Syntax and Semantics of Statements
...
* 4. Syntax and Semantics of Terms
