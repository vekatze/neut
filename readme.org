...
let str-copy-1 := cartesian-string(1, str);
let str-copy-2 := cartesian-string(1, str);
{- THE CODE THAT USES `str-copy-1`, `str-copy-2`, AND `str` LINEARLY -}
#+END_SRC
...
Incidentally, the 3-element representation of a closure is now new. (add references here)
