...
- [[#notes-on-the-structure-of-the-compiler][Notes on The Structure of the Compiler]]
  - [[#overview][Overview]]
  - [[#parse-text---lambda-term-with-possible-holes][Parse: Text -> Lambda-Term With Possible Holes]]
  - [[#elaborate-lambda-term-with-possible-holes---lambda-term][Elaborate: Lambda-Term With Possible Holes -> Lambda-Term]]
  - [[#clarify-lambda-term---lambda-term-in-a-dependent-cbpv][Clarify: Lambda-term -> Lambda-term in a Dependent CBPV]]
  - [[#lower-lambda-term-in-a-dependent-cbpv---llvm-code][Lower: Lambda-term in a Dependent CBPV -> LLVM Code]]
  - [[#emit-llvm-code---text][Emit: LLVM Code -> Text]]
- [[#some-possible-questions-and-answers][Some Possible Questions and Answers]]
  ...
  - [[#can-you-show-me-the-explicit-definition-of-the-target-calculus-a-dependent-cbpv][Can You Show Me the Explicit Definition of the Target Calculus (a Dependent CBPV)?]]
...
** Parse: Text -> Lambda-Term With Possible Holes

** Elaborate: Lambda-Term With Possible Holes -> Lambda-Term

** Clarify: Lambda-term -> Lambda-term in a Dependent CBPV

** Lower: Lambda-term in a Dependent CBPV -> LLVM Code
...
** Can You Show Me the Explicit Definition of the Target Calculus (a Dependent CBPV)?
