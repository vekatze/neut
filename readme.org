...
As for editor support, you can currently try [[https://github.com/vekatze/neut-mode][neut-mode]] and [[https://github.com/vekatze/flycheck-neut][flycheck-neut]] if you're using Emacs. The former package is for syntax highlighting, and the latter one for linting.
...
Now I think you are basically ready to, for example, start reading [[https://github.com/vekatze/neut/tree/master/test/data][the files in the test directory]], or [[https://github.com/vekatze/neut-core][the files in the core library]], referring the sections below as necessary. After that you should know how to write lambdas, recursive functions, inductive types, tuples, etc.
