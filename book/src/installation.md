...
```sh
export NEUT_CORE_MODULE_URL="https://github.com/vekatze/neut-core/raw/main/release/0.2.0.22.tar.zst"
export NEUT_CORE_MODULE_CHECKSUM="ajlQNvUrLdxjZRiCSarZkEDPP6BO2YYqzj64vqPMcWk="
```
