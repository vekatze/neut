...
echo ""
echo "export NEUT_CORE_MODULE_URL=\"https://github.com/vekatze/neut-core/raw/main/archive/0-49-3.tar.zst\""
echo "export NEUT_CORE_MODULE_DIGEST=\"5eWe_Runvo_wXtLvDa9MVH2tMWKVR3kuJgoBEJwG6hQ\""
