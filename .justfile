...
test-amd64-linux:
    @just _run-amd64-linux NEUT=/app/bin/{{version}}/amd64-linux/neut COMPILER_VERSION={{version}} TARGET_ARCH=amd64 /app/test/test-linux.sh /app/test/misc /app/test/pfds
