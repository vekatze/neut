...
\begin{framed}
  \begin{center}
    ...
    \begin{bprooftree}
      ...
      \RightLabel{\( (\Pi_{\ir{i}}) \)}
      \UnaryInfC{\( \Gamma \vdash \xabs{(x_{1}, \ldots, x_{n})}{e} : \upT{\downT{\dprod{x_{1} : P_{1}, \ldots, x_{n} : P_{n}}{N}}} \)}

    \end{bprooftree}
    \\
    \vspace{1.5em}
    \begin{bprooftree}
      \AxiomC{\( \Gamma \vdash e : \upT{\downT{\dprod{x_{1} : P_{1}, \ldots, x_{n} : P_{n}}{N}}} \)}
      \AxiomC{\( \Gamma \vdash e_{1} : P_{1} \hspace{1em} \ldots \hspace{1em} \Gamma \vdash e_{n} : P_{n} \)}
      \RightLabel{\( (\Pi_{\ir{e}}) \)}
      \BinaryInfC{\( \Gamma \vdash \bind{e_{1}}{f}{\appE{(\forceS{f})}{(e_{1}, \ldots, e_{n})} : N \subst{x_{i}}{e_{i}}} \)}
    \end{bprooftree}
    \\
    \vspace{1.5em}
    \begin{bprooftree}
    ...
    \begin{bprooftree}
      ...
      \AxiomC{\( \Gamma \vdash e_{n} : P_{n} \subst{x_{1}}{e_{1}}\ldots\subst{x_{n-1}}{e_{n-1}} \)}
      \RightLabel{\( (\Sigma_{\ir{i}}) \)}
      \TrinaryInfC{\( \Gamma \vdash \vret{(e_{1}, \ldots, e_{n})} : \upT{\dsum{x_{1} : P_{1}, \ldots, x_{n-1} : P_{n-1}}{P_{n}}} \)}
    \end{bprooftree}
    \\
    \vspace{1.5em}
    \begin{bprooftree}
      \AxiomC{\( \Gamma \vdash e : \upT{\dsum{x_{1} : P_{1}, \ldots, x_{n-1} : P_{n-1}}{P_{n}}} \)}
      \AxiomC{\( \Gamma, x_{1} : P_{1}, \ldots, x_{n} : P_{n} \vdash e' : N \subst{z}{(x_{1}, \ldots, x_{n})} \)}
      \RightLabel{\( (\Sigma_{\ir{e}}) \)}
      \BinaryInfC{\( \Gamma \vdash \bind{e}{x}{\LET{(x_{1}, \ldots, x_{n})}{x}{e'}} : N \subst{z}{e} \)}
    \end{bprooftree}
    \\
    \vspace{1.5em}
    % \begin{bprooftree}
